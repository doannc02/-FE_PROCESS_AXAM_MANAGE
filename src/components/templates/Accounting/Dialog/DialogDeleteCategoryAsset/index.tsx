...
import useDialogDeleteCategory from './useDialogDeleteCategoryAsset'

const DialogDeleteCategoryAsset = ({
  id,
  refetch,
}: {
  id: number
  ...
  const [values, handles] = useDialogDeleteCategory({ id, refetch })
  ...
  return (
    <DialogCustom title='' onClose={hideDialog} width={520}>
      <Box className='flex justify-center px-25 m-auto align-middle text-center'>
        ...
        >
          Bạn có chắc chắn muốn xoá danh mục này hay không?
        </Typography>
      </Box>
...
export default DialogDeleteCategoryAsset
