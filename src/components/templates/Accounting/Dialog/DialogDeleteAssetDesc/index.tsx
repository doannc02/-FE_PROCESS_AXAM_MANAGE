...
import useDialogDeleteAssetDesc from './useDialogDeleteAssetDesc'

const DialogDeleteAssetDesc = ({
  id,
  refetch,
}: {
  id: number
  ...
  const [values, handles] = useDialogDeleteAssetDesc({ id, refetch })
...
export default DialogDeleteAssetDesc
