...
export const getDetailPricingConfig = async (
...
export const useQueryGetDetailPricingConfig = (
  params: RequestBody['GET'],
  options?: any
) => {
  ...
  return useQuery<Response['GET']>(
    [
      `/api/v1/${warehouseNestedType[typeWareHouse]}/pricing-method-config`,
      params,
    ],
    () => getDetailPricingConfig(params, typeWareHouse),
